...
<head>
  ...
  <style>body{font-family:'Poppins',sans-serif;padding:1.25rem;background:#f4f6f8} .wrap{max-width:800px;margin:0 auto} label{display:block;margin-top:.5rem}</style>
</head>
<body>
  <div class="wrap">
