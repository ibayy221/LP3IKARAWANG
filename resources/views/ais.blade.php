	...
	<div class="wrap">
		<div class="card">
			<div class="grid">
				...
				<div class="aside">
					<img class="program-img" src="{{ asset('storage/image/AIS.jpg') }}" alt="Program Manajemen Pemasaran" onerror="this.onerror=null;this.src='{{ asset('storage/image/AIS.png') }}'">
                    <br>
                    <br>
                    <br>
                     <br>
                    <br>
                    <br>
                    <img class="program-img" src="{{ asset('storage/image/AIS2.jpg') }}" alt="Program Manajemen Pemasaran" onerror="this.onerror=null;this.src='{{ asset('storage/image/AIS.png') }}'">
                    <br>
                    <br>
                     <br>
                    <br>
                    <br>
                    <br>
                    <img class="program-img" src="{{ asset('storage/image/AIS3.jpg') }}" alt="Program Manajemen Pemasaran" onerror="this.onerror=null;this.src='{{ asset('storage/image/AIS.png') }}'">
