	...
	<div class="wrap">
		<div class="card">
			<div class="article">
				...
				<figure>
					<img class="article-img" src="{{ asset('storage/image/AIS.jpg') }}" alt="Program AIS" onerror="this.onerror=null;this.src='{{ asset('storage/image/AIS.png') }}'">
				...
				<figure>
					<img class="article-img" src="{{ asset('storage/image/AIS2.jpg') }}" alt="Kegiatan akademik AIS" onerror="this.onerror=null;this.src='{{ asset('storage/image/AIS.png') }}'">
				...
				<figure>
					<img class="article-img" src="{{ asset('storage/image/AIS3.jpg') }}" alt="Aktivitas mahasiswa AIS" onerror="this.onerror=null;this.src='{{ asset('storage/image/AIS.png') }}'">
