      ...
      <div class="actions">
        <div class="hdr-menu">
          ...
          <div id="hdr-menu" class="menu" style="display:none;">
            <form method="POST" action="{{ url('/marketing/logout') }}">@csrf<button type="submit">Logout</button></form>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="card">
      ...
      <div class="stats" aria-hidden="false">
        <div class="stat-card">
          ...
          <div>
            <div class="stat-number">{{ number_format($totalPendaftar) }}</div>
        ...
        <div class="stat-card">
          ...
          <div>
            <div class="stat-number">{{ $jurusanTerbanyak }}</div>
