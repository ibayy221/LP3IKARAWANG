...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <form action="{{ route('pendaftar.verify-code-submit') }}" method="POST">
                @csrf
                ...
                <div class="button-group">
                    ...
                    <a href="{{ route('pendaftar.forgot-password') }}" class="btn btn-secondary">
            ...
            <div class="resend-link">
                Tidak menerima kode? <a href="{{ route('pendaftar.forgot-password') }}">Minta kode baru</a>
            </div>
        </div>
    </div>
