...
<body>
    ...
    <div class="admin-container">
        ...
        <div class="admin-content">
            ...
            <div class="main-content">
                ...
                <!-- Carousel Kegiatan Management Section (DIPINDAHKAN) -->
                </div>
    ...
    <script>
                ...
                function fetchCarouselKegiatan() {
                    fetch('/admin/carousel-kegiatan')
                        .then(res => res.json())
                        .then(res => {
                            if (res.success) {
                                carouselKegiatanData = res.data;
                ...
                function deleteKegiatanSlide(id) {
                    ...
                    fetch(`/admin/carousel-kegiatan/${id}`, { method: 'DELETE', headers: {'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content } })
                        .then(res => res.json())
                        .then(res => { if (res.success) fetchCarouselKegiatan(); });
                }
                function handleKegiatanFormSubmit(e) {
                    ...
                    let method = 'POST';
                    if (id) { url += `/${id}`; }
                    fetch(url, { method: method, body: formData, headers: {'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content } })
                        .then(res => res.json())
                        .then(res => {
                            if (res.success) {
                                closeKegiatanModal();
