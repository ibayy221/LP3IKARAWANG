    ...
    <div class="wrap">
        <div class="card">
            <div class="article">
                ...
                <figure>
                    <img class="article-img" src="<?php echo e(asset('storage/image/ASE.jpg')); ?>" alt="Program ASE" onerror="this.onerror=null;this.src='<?php echo e(asset('storage/image/ASE.png')); ?>'">
                    <figcaption>Suasana perkuliahan dan praktik pengembangan aplikasi.</figcaption>
                </figure>
                ...
                <figure>
                    <img class="article-img" src="<?php echo e(asset('storage/image/ASE2.jpg')); ?>" alt="Kegiatan akademik ASE" onerror="this.onerror=null;this.src='<?php echo e(asset('storage/image/ASE.png')); ?>'">
                ...
                <figure>
                    <img class="article-img" src="<?php echo e(asset('storage/image/ASE3.jpg')); ?>" alt="Aktivitas mahasiswa ASE" onerror="this.onerror=null;this.src='<?php echo e(asset('storage/image/ASE.png')); ?>'">
                    <figcaption>Praktik komunikasi tim dan penyusunan solusi.</figcaption>
                </figure>
