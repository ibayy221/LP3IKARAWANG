...
<body>
    <div class="container">
        ...
        <div class="form-container">
            ...
            <form method="POST" action="<?php echo e(route('struktur-organisasi.update', $strukturOrganisasi)); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <?php echo method_field('PUT'); ?>

                <div class="form-group">
                    <label for="nama"><i class="fas fa-user"></i> Nama Lengkap *</label>
                    <input type="text" id="nama" name="nama" value="<?php echo e(old('nama', $strukturOrganisasi->nama)); ?>" required>
                </div>

                <div class="form-group">
                    <label for="role"><i class="fas fa-briefcase"></i> Role/Jabatan *</label>
                    <input type="text" id="role" name="role" value="<?php echo e(old('role', $strukturOrganisasi->role)); ?>" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select id="posisi" name="posisi" required onchange="updateParentOptions()">
                        ...
                        <?php $__currentLoopData = $posisiOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($value); ?>" <?php echo e(old('posisi', $strukturOrganisasi->posisi) == $value ? 'selected' : ''); ?>>
                                <?php echo e($label); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="urutan" name="urutan" value="<?php echo e(old('urutan', $strukturOrganisasi->urutan)); ?>" min="0">
                </div>

                <div class="form-group">
                    <label><i class="fas fa-image"></i> Foto Saat Ini</label>
                    <?php if($strukturOrganisasi->foto): ?>
                        <div class="current-photo">
                            <img src="<?php echo e(Storage::url($strukturOrganisasi->foto)); ?>" alt="<?php echo e($strukturOrganisasi->nama); ?>">
                        </div>
                    <?php else: ?>
                ...
                <div class="form-group">
                    <div class="checkbox-group">
                        <input type="checkbox" id="is_active" name="is_active" value="1" <?php echo e(old('is_active', $strukturOrganisasi->is_active) ? 'checked' : ''); ?>>
    ...
    <script>
        ...
        let currentParentId = '<?php echo e(old('parent_id', $strukturOrganisasi->parent_id)); ?>';
...
<?php /**PATH D:\Lp3i\LP3IKARAWANG\resources\views/admin/struktur_organisasi/edit.blade.php ENDPATH**/ ?>