...
<head>
  ...
  <style>
    ...
    .card{background:#ffffff;padding:1.25rem;border-radius:10px;box-shadow:0 6px 24px rgba(15,23,42,0.06)}
    label{display:block;margin-bottom:.4rem;font-weight:600}
    .form-control{width:100%;padding:.6rem;border-radius:8px;border:3px solid #eef2f7;font-size:0.95rem;line-height:1.25}
    /* Polished select */
...
<body>
  <div class="wrap">
    <div class="card">
      ...
      <form method="POST" action="<?php echo e(route('marketing.pendaftar.store')); ?>">
        <?php echo csrf_field(); ?>
        ...
        <div style="margin-top:1rem;text-align:right">
          <a href="<?php echo e(route('marketing.pendaftar.index')); ?>" style="margin-right:.5rem">Batal</a>
...
</html><?php /**PATH D:\Lp3i\LP3IKARAWANG\resources\views/marketing/pendaftar/create.blade.php ENDPATH**/ ?>