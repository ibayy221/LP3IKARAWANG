...
<body>
        ...
        <nav>
            ...
            <ul class="nav-links">
                ...
                <li class="dropdown">
                    ...
                    <div class="dropdown-content">
                        <a href="<?php echo e(route('pedoman.download')); ?>" target="_blank" rel="noopener noreferrer">Download Pedoman Kerja</a>
    ...
    <section class="about" id="about">
        ...
        <div class="banner">
            <img src="<?php echo e(asset('storage/image/apiliasi.png')); ?>" alt="Sejarah LP3I Karawang">
        </div>
    </section>
