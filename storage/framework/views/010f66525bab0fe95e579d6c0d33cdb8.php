            ...
            <div class="org-tree">
                <div class="center-card">
                    <div class="person-card director">
                        <img src="<?php echo e(asset('storage/image/Pemimpin.jpg')); ?>" alt="Pemimpin">
                ...
                <div class="center-card-sub">
                    <div class="person-card subordinate">
                        <img src="<?php echo e(asset('storage/image/Pemimpin.jpg')); ?>" alt="Wakil Branch Manager">
                ...
                <div class="grid">
                    <div class="person-card">
                        <img src="<?php echo e(asset('storage/image/Pemimpin.jpg')); ?>" alt="Wakil Akademik">
                        <h3>Eko Marmanto, S.Kom.,M.Kom. ,MOS.,CDMP.</h3>
                        <div class="role">Head of Education & IT Department</div>
                    </div>
                    <div class="person-card">
                        <img src="<?php echo e(asset('storage/image/Pemimpin.jpg')); ?>" alt="Wakil Non Akademik">
